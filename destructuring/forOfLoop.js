...
//using For-Of
for(const item of menu) //console.log(item); destru

//using destructuring
for(const [i, el] of menu.entries()) /*console.log(`${i + 1}: ${item[el]}`);*/
...
//Question 1. Use the for-of loop to loop over the books array and sum the pages of all books. Use the pageSum
// variable below, and the pages property of the book objects.
let pageSum = books.entries();
console.log(pageSum);
